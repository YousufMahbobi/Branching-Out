...
def filter_by_email(email):
    ...
    filtered_users_email = [user for user in users if user["email"] == email]
...
if __name__ == "__main__":
    filter_option = input("What would you like to filter by? (Currently, only 'name, age, email' is supported): ").strip().lower()
